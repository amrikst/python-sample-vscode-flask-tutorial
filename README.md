[![Build Status](https://dev.azure.com/amriktaggarlab/YAML/_apis/build/status/amrikst.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/amriktaggarlab/YAML/_build/latest?definitionId=1&branchName=master)
